...
* Docker
* sudo apt-get install -y libgdk-pixbuf2.0-dev (required)
...
The `main.pdf` file will be generated in the `./build/` directory upon successful completion of the build process.
